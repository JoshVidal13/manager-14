...
export default function ExpenseIncomeManager() {
  ...
  // Group entries by week - CAMBIADO: Ahora las semanas empiezan en jueves (4)
  const entriesByWeek = useMemo(() => {
    ...
    // Get all weeks in the range - CAMBIADO: weekStartsOn: 4 (jueves)
    ...
    return weeks
      .map((weekStart) => {
        const weekEnd = endOfWeek(weekStart, { weekStartsOn: 4 })
